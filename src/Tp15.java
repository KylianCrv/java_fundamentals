...
public class Tp15 {
    public static void main(String[] args) {
        ...
        System.out.print("Entrez une taille pour les deux tableaux :");
        ...
        for (int i=0; i<tabMultiD.length;i++){
            ...
            for (int j=0; j< tabMultiD.length;j++){
        ...
        System.out.println("Liste résultat : "+ Arrays.toString(tabResultat));
